...
//     try {
//       const response = await axios.get(`http://your-backend-url/api/search/${searchNumber}`);
...
//               <h5 style={{ marginTop: '30px', marginLeft: '10px', fontSize: '25px' }}>
//                 قم بإدخال الرقم القومى المراد الاستعلام عنه لعام 2023-2024
//               </h5>
//               <div className="row g-3 mt-2">
//                 <div className="col-md-3"></div>
//                 <div className="col-md-6" style={{ marginRight: '-30px', width: '500px', marginTop: '20px' }}>
...
//                     disabled={isLoading}
//                     style={{ marginRight: '360px', marginTop: '20px' }}
//                   >
//                     {isLoading ? 'جاري البحث...' : 'استعلام'}
//                   </button>
//                 </div>
