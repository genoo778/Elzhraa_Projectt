...
//   useEffect(() => {
//     // Fetch university fees from the backend when the component mounts
//     axios.get('/api/universityfees')
//       .then(response => {
//         setUniversityDetails(response.data);
//       })
//       .catch(error => {
//         console.error('Error fetching university fees:', error);
//       });
//   }, []);
...
//   const handleAddOptionAndCloseModal = () => {
//     if (newTitle && !universityDetails[newTitle]) {
//       axios.post('/api/universityfees', {
//         title: newTitle,
//         details: newOptionDetails,
//       })
//       .then(response => {
//         setUniversityDetails(prevState => ({
//           ...prevState,
//           [response.data.title]: response.data.details,
//         }));
//         setNewOptionDetails({
//           housingModel: '',
//           housingType: '',
